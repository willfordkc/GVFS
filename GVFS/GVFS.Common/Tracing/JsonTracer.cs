...
namespace GVFS.Common.Tracing
{
    public class JsonTracer : ITracer
    {
        ...
        public JsonTracer(string providerName, string activityName, bool useCriticalTelemetryFlag = true)
            : this(providerName, Guid.Empty, activityName, useCriticalTelemetryFlag)
        {
        }

        public JsonTracer(string providerName, Guid providerActivityId, string activityName, bool useCriticalTelemetryFlag = true)
            : this(
