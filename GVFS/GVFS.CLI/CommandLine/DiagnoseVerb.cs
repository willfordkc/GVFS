    ...
    public class DiagnoseVerb : GVFSVerb.ForExistingEnlistment
    {
        ...
        private void PrintDiskSpaceInfo(string localCacheRoot, string enlistmentRootParameter)
        {
            try
            {
                ...
                bool enlistmentSuccess = Paths.TryGetNormalizedPathRoot(enlistmentRootParameter, out enlistmentNormalizedPathRoot, out enlistmentErrorMessage);
                bool localCacheSuccess = Paths.TryGetNormalizedPathRoot(localCacheRoot, out localCacheNormalizedPathRoot, out localCacheErrorMessage);
