    ...
    public class CloneVerb : GVFSVerb
    {
        ...
        public override void Execute()
        {
            ...
            if (!string.IsNullOrWhiteSpace(this.LocalCacheRoot))
            {
                ...
                if (!Paths.TryGetNormalizedPath(fullLocalCacheRootPath, out normalizedLocalCacheRootPath, out errorMessage))
                {
            ...
            this.CheckNTFSVolume(normalizedEnlistmentRootPath);
        ...
        private string GetCloneRoot(out string fullEnlistmentRootPathParameter)
        {
            ...
            try
            {
                ...
                if (!Paths.TryGetNormalizedPath(fullEnlistmentRootPathParameter, out enlistmentRootPath, out errorMessage))
                {
        ...
        private void CheckNTFSVolume(string normalizedEnlistmentRootPath)
        {
            ...
            {
                this.Output.WriteLine();
                this.Output.WriteLine($"WARNING: Unable to ensure that '{normalizedEnlistmentRootPath}' is an NTFS volume.");
            }
        ...
        private void CheckNotInsideExistingRepo(string normalizedEnlistmentRootPath)
        {
            ...
            if (Paths.TryGetGVFSEnlistmentRoot(normalizedEnlistmentRootPath, out existingEnlistmentRoot, out errorMessage))
            { 
