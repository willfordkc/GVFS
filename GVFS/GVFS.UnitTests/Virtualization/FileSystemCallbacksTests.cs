...
namespace GVFS.UnitTests.Virtualization
{
    ...
    public class FileSystemCallbacksTests : TestsWithCommonRepo
    {
        ...
        {
            FileSystemCallbacks.IsPathInsideDotGit(@".git\").ShouldEqual(true);
            FileSystemCallbacks.IsPathInsideDotGit(@".GIT\").ShouldEqual(true);
            FileSystemCallbacks.IsPathInsideDotGit(@".git\test_file.txt").ShouldEqual(true);
            FileSystemCallbacks.IsPathInsideDotGit(@".GIT\test_file.txt").ShouldEqual(true);
            FileSystemCallbacks.IsPathInsideDotGit(@".git\test_folder\test_file.txt").ShouldEqual(true);
            FileSystemCallbacks.IsPathInsideDotGit(@".GIT\test_folder\test_file.txt").ShouldEqual(true);
        }
