...
perfview start /AcceptEULA /NoGui /NoNGenRundown /Merge /Zip /Providers:*Microsoft.Git.GVFS:@StacksEnabled=true,*Microsoft.Internal.Git.Plugin:@StacksEnabled=true,*Microsoft.OSGENG.Testing.GitMsWrapper:@StacksEnabled=true /logfile:"%perfviewstartlog%" "%perfviewfilename%" || goto :HandlePerfViewStartError
echo.
set STARTTIME=%TIME%
%*
set ENDTIME=%TIME%
...
perfview stop /AcceptEULA /NoGui /NoNGenRundown /Merge /Zip /Providers:*Microsoft.Git.GVFS:@StacksEnabled=true,*Microsoft.Internal.Git.Plugin:@StacksEnabled=true,*Microsoft.OSGENG.Testing.GitMsWrapper:@StacksEnabled=true  /logfile:"%perfviewstoplog%" || goto :HandlePerfViewStopError
CALL :CheckForFile
